...
import com.example.intelliplanner.databinding.DialogCustomBinding

interface CustomDialogInterface {
    fun onButtonClicked(id: Int)
}
class CustomDialog(
    confirmDialogInterface: CustomDialogInterface,
    ...
    //프로퍼티(멤버변수)
    private var confirmDialogInterface: CustomDialogInterface? = null
